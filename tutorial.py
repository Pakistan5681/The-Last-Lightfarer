...
def tutorial():
    ...
    new = Monster("sprites//flame hop//flame hopper v1-1.png.png", spawn, MWeapon("Does it matter?", 10, "pawn", 1), 10, "sprites//Player Attacks//fireball_01.png")
    new.health = 50
    monsters = [new] 
    active_projectiles = []
