...
def main_game():
    ...
    if run:
        ...
        monsters = [Monster("sprites/Drpplet/Dropplet.png", (3, 3), MWeapon("Generic Ah Weapon", 5, "bishop", 1),25,"sprites/Player Attacks/fireball_01.png")]
        running = True
        attackSquares = []
        moveSquares = []
